...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: because rando was declared inside the scope of the while loop block, so according to the rules of let and const it will give an error when used outside of its scope which is what happened.
  console.log(viewed);
